...
//            render : 게시물 리스트 아이템 컴포넌트 랜더링            //
  return (
    <div className='board-list-item-card' onClick={onCardClickHandler}>
      <div className='board-list-item-main-box'>
        <div className='board-list-item-top'>
          <div className='board-list-item-profile-box'>
           <div className='board-list-item-profile-image' style={{backgroundImage : `url(${profileImageUrl ? profileImageUrl : DefualtProfileImage})`}}></div>
          </div>
